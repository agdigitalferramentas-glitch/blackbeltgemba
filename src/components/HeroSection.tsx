      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 py-10 sm:py-16 md:py-24">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          ...
          <div className="flex-1 text-left">
            ...
            <h1 className="font-display text-2xl sm:text-3xl md:text-[2.25rem] lg:text-[2.5rem] font-bold text-hero-foreground tracking-tight mb-5 sm:mb-8 max-w-[28ch] animate-fade-in-up text-balance" style={{ animationDelay: "0.1s", lineHeight: "1.5rem" }}>
