    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="font-display text-3xl md:text-5xl lg:text-6xl font-bold text-hero-foreground leading-tight mb-8 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
          ...
          <p className="text-hero-foreground/80 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto mb-6 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
          ...
          <p className="text-gold-light/70 text-sm md:text-base max-w-2xl mx-auto mb-10 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
